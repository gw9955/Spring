...
$(function(){
	...
	function handleImgFileSelect(e) {
		// 이벤트가 발생된 타겟 안에 이미지 파일들을 가져오자
		let files = e.target.files;
		// 이미지가 여러개가 있을 수 있으므로 이미지를 분리하여 배열로 만든다
		...
		fileArr.forEach(function(f) {
			...
			// 이미지 객체를(f) 전역 배열타입 변수(sel_file)에 넣는다
			sel_file.push(f);
...
<!-- ========================= 상품 등록 시작 =================================== -->
	<div class="container">
		...
		<!-- 사용자 정보 -->
		<p>princtipal : <sec:authentication property="principal"/> </p>
