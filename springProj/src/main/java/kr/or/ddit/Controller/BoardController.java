...
public class BoardController {
   ...
   @RequestMapping(value="/register") //value 속성 /board/register/ 값
...
//      return mav;
   ...
   /* 3. Http 메서드 매핑
       method 속성을 사용하여 HTTP 메서드를 매핑 조건으로 지정 가능
       화면으로 응답하는 경우 HTTP 메서드로 GET방식과 POST 방식 두 가치를 사용함
    */
   //골뱅이 GetMapping("/register2")
