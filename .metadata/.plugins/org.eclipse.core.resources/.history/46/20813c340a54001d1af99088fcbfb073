	...
	<div class="container">
		...
		<form name="newProduct" action="/update" class="form-horizontal" method="post">
			...
			<div class="form-group row">
				...
				<div class="col-sm-3">
					<input type="text" id="unitsInStock" name="unitsInStock" class="form-control" value="${data.unitsInStock}">
				</div>
			</div>
			<div class="form-group row">
